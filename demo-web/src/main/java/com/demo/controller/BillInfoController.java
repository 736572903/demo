...
public class BillInfoController {
    ...
    public String queryBillInfo() {
        ...
        boolean save = billInfoService.saveBatch(batchList);
        ...
        userUpdateWrapper.set("card_id", 9999L)
                .setSql("original_bill_id = 8888")
                .eq("card_id", 0L).or().eq("card_id", 8888L);
        ...
        queryWrapper.select("card_id", "original_bill_id")
                .gt("id", 1700L)
                .between("id", 1600L, 1750L)
                .groupBy("id")
                .orderByDesc("id");
